...
public class GameView {
    ...
    private void setupGameGrid() {
        if (gameGrid != null) {
            ...
            for (int x = 0; x < Constants.BOARD_WIDTH; x++) {
                for (int y = 0; y < Constants.BOARD_HEIGHT; y++) {
                    ImageView cellView = getImageView();
    ...
    private Image createColoredImage(Color color) {
        ...
        // Pour les explosions : dessiner une croix
            ...
            gc.setStroke(color);
            // Croix horizontale
            gc.strokeLine(margin, (double) Constants.CELL_SIZE / 2,
                    Constants.CELL_SIZE - margin, (double) Constants.CELL_SIZE / 2);
            // Croix verticale
            gc.strokeLine((double) Constants.CELL_SIZE / 2, margin,
                    (double) Constants.CELL_SIZE / 2, Constants.CELL_SIZE - margin);
        }
